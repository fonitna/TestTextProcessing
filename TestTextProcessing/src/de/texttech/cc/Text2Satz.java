...
public class Text2Satz
{
	...
	private static Vector count_line_all;
...
"tei] [-n] [textfiles|-f filefile]"
    ...
    public int processText(String s)
    {
       ...
       // System.out.println(">>>breakiterator:::::"+breakiterator.getText());
        try
        {
            bufferedinputstream = new BufferedInputStream(new FileInputStream(file));
        ...
        try
        {
        	//System.out.println("1stringbuffer::"+stringbuffer.toString());
            dataoutputstream.writeBytes(/*"\n" +*/ taggedHeader(s));
            long l1 = l;
            long l6;
            do
            ...
            {
            	count_line++;
                System.out.println("End of sentence after this word::"+stringbuffer.toString()+"("+count_line+")");
                ...
                for(int k2 = i2 - l; k2 > 0; k2--)
                {
                    ...
                    if(i == 10 || i == 13 || k1 == 0)
                    {
                        if(k1 <= i1)
                        {
                            ...
                            stringbuffer.delete(0, stringbuffer.length());
                            //System.out.println("2stringbuffer::"+stringbuffer.toString());
                        ...
                        if(j == 32)
                        {
                            ...
                            //System.out.println("3stringbuffer::"+stringbuffer.toString());
                            j = (char)bufferedinputstream2.read();
                            k1++;
                            stringbuffer.append((char)j);
                            //System.out.println("4stringbuffer::"+stringbuffer.toString());
                        }
                        if(stringbuffer.toString().compareTo(" <") == 0)
                        {
                            stringbuffer.delete(0, stringbuffer.length());
                            //System.out.println("5stringbuffer::"+stringbuffer.toString());
                            int j3 = 0;
                            do
                            {
                                ...
                                k1++;
                                stringbuffer.append((char)j);
                                //System.out.println("6stringbuffer::"+stringbuffer.toString());
                            } while(++j3 <= 25 && j != 10);
                            k1++;
                            if(stringbuffer.toString().compareTo("quelle") == 0)
                            {
                            	System.out.println("LINE495 stringbuffer = "+stringbuffer);
                                dataoutputstream.writeBytes("\n <" + stringbuffer + ">");
                                stringbuffer.delete(0, stringbuffer.length());
                               // System.out.println("7stringbuffer::"+stringbuffer.toString());
                                while((i = bufferedinputstream2.read()) != 10 && i > 0) 
                                {
                                    k1++;
                                    stringbuffer.append((char)i);
                                    //System.out.println("8stringbuffer::"+stringbuffer.toString());
                                }
                                k1++;
                               ...
                               // System.out.println("9stringbuffer::"+stringbuffer.toString());
                                if(stringbuffer.length() == 0)
                                {
                                    stringbuffer.append(s);
                                    //System.out.println("10stringbuffer::"+stringbuffer.toString());
                                }
                               // System.out.println("11stringbuffer::"+stringbuffer.toString());
                                success++;
                            ...
                            {
                                dataoutputstream.writeBytes("\n <" + stringbuffer + ">");
                               // System.out.println("12stringbuffer::"+stringbuffer.toString());
                                k1 += writeRestOfLine(dataoutputstream, bufferedinputstream2) + 1;
                            } else
                            {
                                dataoutputstream.writeBytes("\n <" + stringbuffer);
                                //System.out.println("13stringbuffer::"+stringbuffer.toString());
                ...
                if(breakiterator.current() > 2)
                {
                    ...
                    {
                        stringbuffer.delete(0, stringbuffer.length());
                        //System.out.println("14stringbuffer::"+stringbuffer.toString());
                        long l10;
                        do
                        {
                       ...
                       // System.out.println("End of sentence after this word::"+stringbuffer.toString()+"("+count_line+")");
                        ...
                        {
                        	//System.out.println("16stringbuffer::"+stringbuffer.toString());
                            do
                            {
                            ...
                            //System.out.println("17stringbuffer::"+stringbuffer.toString());
                        }
        ...
        success++;
        //System.out.println("18stringbuffer::"+stringbuffer.toString());
        return 1;
    }
    
    public static Vector getCountLineAll() {
    	return count_line_all;
    }
        ...
        throws IllegalArgumentException
    {
        ...
        do
        {
            ...
            {
            case 100: // 'd'
            	System.out.println("-----> doing case 100 (d)");
                text2satz.setDatabase(getopt.getOptarg());
                break;

            case 104: // 'h'
            	System.out.println("-----> doing case 104 (h)");
                text2satz.setHtmlConverter(getopt.getOptarg());
                break;

            case 97: // 'a'
            	System.out.println("-----> doing case 97 (a)");
                s = getopt.getOptarg();
                System.out.println("abbrev file : "+s);
                break;

            case 102: // 'f'
            	System.out.println("-----> doing case 110 (n)");
                s1 = getopt.getOptarg().trim();
                break;

            case 76: // 'L'
            	System.out.println("-----> doing case 76 (L)");
            ...
            case 109: // 'm'
            	System.out.println("-----> doing case 109 (m)");
            ...
            case 112: // 'p'
            	System.out.println("-----> doing case 112 (p)");
                text2satz.setWorkingDir(getopt.getOptarg());
                break;

            case 114: // 'r'
            	System.out.println("-----> doing case 114 (r)");
                text2satz.setRawMode(true);
                break;

            case 118: // 'v'
            	System.out.println("-----> doing case 118 (v)");
                text2satz.verbose = true;
                break;

            case 86: // 'V'
            	System.out.println("-----> doing case 86 (V)");
                System.out.println("text2satz 1.1");
                flag = true;
                break;

            case 119: // 'w'
            	System.out.println("-----> doing case 119 (w)");
                text2satz.setWrapLongLines(true);
                break;

            case 63: // '?'
            	System.out.println("-----> doing case 63 (?)");
                flag = true;
                break;
            }
        } while(true);
        ...
        System.out.println("-----> call function readAbbrevs");
        ...
        if(j < args.length){
            ...
            for(j = j; j < args.length; j++){
            	c++;
            	System.out.println("-----> call function processText("+c+")");
            	//count_line=0;
                text2satz.processText(args[j]);
                count_line_all.add(count_line);
            }
